...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/js/order/ordersucc.js'/>"></script>
</head>
...
<div class="div2">
    ...
    <a href="<c:url value='/order/toPay?oid=${sessionScope.oid}'/>" id="linkPay">支付</a>
</div>
</body>
</html>
